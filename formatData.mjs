...
async function reformatTagsColumn(inputFile, outputFile, tagsColumn) {
...
async function processExcelFile() {
  ...
  // Step 1: Format Tags
  await reformatTagsColumn(inputFile, 'temp_tags.xlsx', tagsColumn);

  // Step 2: Format Phone Numbers
  await reformatPhoneNumbers('temp_tags.xlsx', 'temp_phone.xlsx', phoneNumberColumns);
